...
# Author: Archer
# Date: 12/Jan/2017
# Desc: 第四阶段给家居建材的CP-JIAJU-JIANCAI-JIADIAN-SELL CP-JIAJU-JIANCAI-JIADIAN-SELL-OUT
#       在阶段一二三清洗的基础上，根据采集点point_name和标签系统匹配情况来处理。
# File: TagJiaJuJianCaiV4.py
import psycopg2
