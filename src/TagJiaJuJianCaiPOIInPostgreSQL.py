...
#
# Author: Archer
# File: TagJiaJuJianCaiPOIInPostgreSQL.py
...
def main():
	...
	for tagRow in tagCursor:
		...
		" '%" + tagRow['name'] + "%' AND prop.ref_cptype_code LIKE 'CP-JIAJU%'"
		...
		for cpPropRow in cpPropCursor:
			tmpDict = {
				...
				'ref_brand_code': getBrandCode(conn, brandCursor, cpPropRow['point_name'], 'JIAJU-JIANCAI-JIADIAN')
			}
