...
tags = []
with open('../data/jiajujiancaipropvaluetagsuniq.txt') as F:
    for line in F:
...
for tag in tags:
    ...
    name = tag
    descriptions = tag
    sql = "insert into tbl_tag_def (id, name, descriptions, flag) values (" + str(id) + ", '" + name + "', '" + descriptions + "', 'JIAJU-PROP-VALUE')"
    print sql
