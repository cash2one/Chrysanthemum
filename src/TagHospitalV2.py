...
# Author: Archer
# Date: 23/Jan/2017
# Desc: 第二阶段给医院的CP-HOSPITAL-ROOM, CP-PRIVATE-HOSPITAL-ROOM
#       根据prop_value app 标签对照表清洗 ../data/jiajujiancaipropvalue.csv
# File: TagHospitalV2.py
import psycopg2
